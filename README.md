...
- T7 Linux 跨阶段验收与已知缺口：[执行报告](.chorus/specs/rss-reader/2026-09-23-theme-preview/t7-aggregate.md)。T4 后的 MCP 固定预览已修复，共用只读外观编辑器；原生 Wayland 真实点击组合项仍待用户在场单跑，独立评审另行安排。
