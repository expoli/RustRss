...
const DICTS = {
  'zh-CN': {
    ...
    'sidebar.addPlaceholder': 'https://example.com/feed.xml',
    'sidebar.add': '添加',
    ...
    'reader.shortcuts': '快捷键：j/k 上下 · Enter 打开 · u 未读切换 · s 星标 · r 刷新 · / 搜索 · Esc 清除',
  ...
  en: {
    ...
    'reader.shortcuts':
      'Shortcuts: j/k move · Enter open · u toggle unread · s star · r refresh · / search · Esc clear',
